$(function() {
    function SmartNozzleHeater_Temperature_ViewModel(parameters) {
        var self = this;
    ...
    function SmartNozzleHeater_ViewModel(parameters) {
        var self = this;

        self.tempGraph = parameters[0];
    ...
    OCTOPRINT_VIEWMODELS.push({
        construct: SmartNozzleHeater_Temperature_ViewModel,
        dependencies: ["loginStateViewModel", "settingsViewModel"],
        elements: ["#SmartNozzleHeater_plugin_tempgraph_wrapper"]
    });
    ...
    OCTOPRINT_VIEWMODELS.push([
        ...
        SmartNozzleHeaterViewModel,

        // This is a list of dependencies to inject into the plugin, the order which you request
        // here is the order in which the dependencies will be injected into your view model upon
        // instantiation via the parameters argument
        ["SmartNozzleHeater_Temperature_ViewModel"],
